...
class CREDITOS_CAUSA(models.Model):
    oficina = models.ForeignKey(OFICINAS, on_delete=models.CASCADE, default=None, verbose_name='Oficina')
    cod_cre = models.CharField(max_length=10, null=True, verbose_name='Código Crédito')
    comprobante = models.ForeignKey(DETALLE_PROD, on_delete=models.CASCADE, null=True, default=None, verbose_name='Comprobante')
