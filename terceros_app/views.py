...
class ImprimePDF(View):
    def get(self, request, pk, *args, **kwargs):
        ...
        p.drawString(80, 720, f"Nombre tercero: {dato.nombre}")
        p.drawString(80, 700, f"tercero Administrativo?: {dato.doc_admin}")
        p.drawString(80, 680, f"tercero de Caja?: {dato.doc_caja}")
