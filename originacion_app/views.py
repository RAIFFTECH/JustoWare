...
class Crear(LoginRequiredMixin, SuccessMessageMixin, CreateView):
    ...
    form = CrearForm
    fields = '__all__'
    # widgets = {'originacion': forms.TextInput(attrs={'class': 'form-control rounded-pill'}),
...
class ImprimirPDF(LoginRequiredMixin, View):
    def get(self, request, *args, **kwargs):
        ...
        originacion = ORIGINACION.objects.all().order_by('originacion', 'codigo')
        ...
        datos_tabla = [["asociado", "lin_cre", "monto", "plazo", "gar_cre_sol", "lin_cre_sol", "mod_cre_sol"]]

        for dato in originacion:
            datos_tabla.append([dato.asociado, dato.lin_cre, dato.monto, dato.plazo, dato.gar_cre_sol, dato.lin_cre_sol, dato.mod_cre_sol])
