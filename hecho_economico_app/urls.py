...
from hecho_economico_app.views import maestro_detalle
# Crear, Lista, Detalles, Actualizar, Eliminar, ImprimirPDF, ImprimePDF, ExportarView, 
...
urlpatterns = [
    ...
    path('lista/', maestro_detalle, name='listar_cuenta'),

    # Para mostrar una página con el detalle del registro
    # path('lista/detalles/<int:pk>', maestro_detalle_form.as_view(), name='detalles'),
