...
class HECHO_ECONO(models.Model):
    ...
    anulado = models.CharField(max_length=1, choices=OPC_BOOL, default='N', verbose_name='Anulado?')
    protegido = models.CharField(max_length=1, choices=OPC_BOOL, default='N', verbose_name='Protegido?')
    ...
    canal = models.CharField(max_length=3, choices=OPC_CANALES, default='EFE', verbose_name='Canal')
